...
class HpsMorph_frame:
    ...
    def initUI(self):
        ...
        open_file1.grid(row=0, column=0, sticky=W, padx=(330, 6), pady=(10, 2))

        # BUTTON TO PREVIEW SOUND FILE 1
        preview1 = Button(self.parent, text=">", command=lambda: UF.wavplay(
            self.filelocation1.get()), bg="gray30", fg="white")
        ...
        preview2 = Button(self.parent, text=">", command=lambda: UF.wavplay(
            self.filelocation2.get()), bg="gray30", fg="white")
        ...
        self.transf_output = Button(self.parent, text=">", command=lambda: UF.wavplay(
            'output_sounds/' + os.path.basename(self.filelocation1.get())[:-4] + '_hpsMorph.wav'), bg="gray30", fg="white")
    ...
    def transformation_synthesis(self):
        ...
        try:
            ...
            hM.transformation_synthesis(inputFile1, fs, hfreq1, hmag1, stocEnv1, inputFile2,
                                        hfreq2, hmag2, stocEnv2, hfreqIntp, hmagIntp, stocIntp)
